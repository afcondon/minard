...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b10) {
        return apply1(map43($$const(identity2))(a2))(b10);
      };
    };
  };
            ...
            return function(array4) {
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  case 2:
                    return apply4(map43(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply4(apply4(map43(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top2 - bot) / 4) * 2;
                    return apply4(map43(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
    ...
    return function(f) {
      return function(b10) {
        return runFn3(unconsImpl)(function(v) {
          ...
          return function(as) {
            return bind112(f(b10)(a2))(function(b$prime) {
      ...
      return function(f) {
        return function(ms) {
          return fold2(function(acc) {
            return function(k) {
              return function(v) {
                return apply4(map43(flip(insert(k)))(acc))(f(k)(v));
              };
            };
          })(pure111(empty))(ms);
        };
  ...
  var $$delete5 = function(dictOrd) {
    return coerce3($$delete4(dictOrd));
  };
  ...
  var gDecodeJsonCons = function(dictDecodeJsonField) {
    ...
    return function(dictGDecodeJson) {
      ...
      return function(dictIsSymbol) {
        var reflectSymbol2 = reflectSymbol(dictIsSymbol);
        var insert16 = insert5(dictIsSymbol)()();
        return function() {
          return function() {
            return {
                  ...
                  if (v1 instanceof Just) {
                    return bind2(lmap3(AtKey.create(fieldName))(v1.value0))(function(val) {
                      return bind2(gDecodeJson1(object2)($$Proxy.value))(function(rest) {
                        return new Right(insert16($$Proxy.value)(val)(rest));
                      });
                    });
                  }
                  ;
        ...
        return function($copy_stack) {
          ...
          function $tco_loop(state3, stack) {
            ...
            if (v1 instanceof Just && v1.value0.value0 instanceof Visit) {
              if (member11(v1.value0.value0.value0)(state3.unvisited)) {
                var start4 = {
    ...
    return function(tasks) {
      var addTask = function(acc) {
        return function(task) {
          return insert16(task.id)(new Tuple(task, fromFoldable12(task.depends)))(acc);
        };
      };
          ...
          if (v instanceof Just) {
            var layer = (function() {
              ...
              var depLayers = mapFlipped3(v.value0.depends)(function(depId) {
                return fromMaybe(0)(lookup13(depId)(accLayers));
              });
  ...
  var addLayers = function(dictOrd) {
    ...
    return function(tasks) {
      ...
      return mapFlipped3(tasks)(function(t) {
        return {
          id: t.id,
          layer: fromMaybe(0)(lookup13(t.id)(layers)),
          depends: t.depends
        };
      });
    };
  ...
  var $$delete6 = /* @__PURE__ */ $$delete5(ordString);
          ...
          var derivedPackageDeps = (function() {
            ...
            var addModuleDeps = function(acc) {
              return function(v) {
                ...
                var externalDeps = $$delete6(v["value1"]["package"])(depPackages);
  ...
  var fetchBatchDeclarations = function(moduleNames) {
    ...
    return bind3(fetchJson(apiBaseUrl + ("/api/batch-declarations/" + modulesParam)))(function(result) {
      return pure4(bind12(result)(function(json2) {
    ...
    return {
      ...
      foldl: function(f) {
        var go2 = function(b10) {
          return function(fa) {
            return foldl13(go2)(f(b10)(head3(fa)))(tail2(fa));
          };
        };
        return go2;
      },
      foldMap: function(dictMonoid) {
        ...
        return function(f) {
          var go2 = function(fa) {
            return append18(f(head3(fa)))(foldMap12(go2)(tail2(fa)));
          };
          return go2;
        };
      }
  ...
  var alter3 = /* @__PURE__ */ alter2(ordInt);
  ...
  var withBehaviors = function(tree2) {
    return function(newBehaviors) {
      ...
      ;
      if (tree2 instanceof ConditionalRender) {
        return new ConditionalRender(tree2.value0);
      }
      ;
      if (tree2 instanceof LocalCoordSpace) {
        return new LocalCoordSpace(tree2.value0);
      }
      ;
      throw new Error("Failed pattern match at PSD3.AST (line 322, column 35 - line 329, column 45): " + [tree2.constructor.name]);
    };
  };
  var updateNestedJoin = function(name16) {
    return function(key) {
  ...
  var buildIntMap_ = (pairs) => {
    ...
    for (let i2 = 0; i2 < pairs.length; i2++) {
      map43.set(pairs[i2].key, pairs[i2].value);
    }
    return map43;
  };
  var intMapLookup_ = (key) => (map43) => map43.get(key);
  ...
  var startAnimation = function(onFrame) {
    return function __do3() {
      ...
      return bind6(getCancelRef(cancelRef))(identity11);
    };
  };
  ...
  var $$delete7 = /* @__PURE__ */ $$delete4(ordString);
    ...
    return function(sim) {
      return function __do3() {
        ...
        for_3(toUnfoldable7(toRemove))(function(name16) {
          return modify_($$delete7(name16))(sim.forces);
        })();
  ...
  function selectAll_default2(select12) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, node, i2 = 0; i2 < n; ++i2) {
        if (node = group4[i2]) {
          for (var children3 = select12.call(node, node.__data__, i2, group4), child, inherit2 = get5(node, id5), k = 0, l = children3.length; k < l; ++k) {
  ...
  var joinDataWithKey = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(dictMonadEffect);
    return function(dictFoldable) {
      var fromFoldable28 = fromFoldable(dictFoldable);
      return function(dictEq) {
              ...
              return function(v) {
                return liftEffect12((function() {
                  ...
                  return function __do3() {
                    ...
                    var newDataArray = fromFoldable28(foldableData);
    ...
    return function(datum2) {
      return function(index5) {
        return function(attrs) {
          return traverse_2(function(attr3) {
            if (attr3 instanceof StaticAttr) {
              var $409 = attr3.value0 === "textContent";
              if ($409) {
            ...
            if (attr3 instanceof DataAttr) {
              ...
              var $412 = attr3.value0 === "textContent";
              if ($412) {
            ...
            if (attr3 instanceof IndexedAttr) {
              ...
              var $416 = attr3.value0 === "textContent";
              if ($416) {
                return setTextContent_(val)(element3);
              }
              ;
    ...
    return function(templateFn) {
      return function(boundSel) {
        var v = (function() {
          ...
          ;
          throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1892, column 66 - line 1893, column 32): " + [boundSel.constructor.name]);
        })();
        return traverseWithIndex3(function(idx) {
          return function(datum2) {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1898, column 9 - line 1907, column 25): " + [v1.constructor.name]);
          };
        })(v.data);
      };
    };
    ...
    return function(templateFn) {
      return function(pendingSel) {
        var v = (function() {
          ...
          ;
          throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1835, column 68 - line 1836, column 34): " + [pendingSel.constructor.name]);
        })();
        var $480 = $$null(v.parentElements);
        if ($480) {
          return pure9([]);
        }
        ;
        return traverseWithIndex3(function(idx) {
          return function(datum2) {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1848, column 11 - line 1868, column 51): " + [v1.constructor.name]);
          };
        })(v.pendingData);
      };
    };
      ...
      return function(v1) {
        return function(v2) {
            ...
            return function __do3() {
              ...
              var element3 = (function() {
                if (childSel instanceof EmptySelection) {
                  var v32 = head(childSel.value0.parentElements);
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1214, column 29 - line 1216, column 102): " + [v32.constructor.name]);
                }
                ;
          ...
          if (v1 instanceof ConditionalRender && v2 instanceof Just) {
            var v3 = find2(function(c) {
              return c.predicate(v2.value0);
            })(v1.value0.cases);
            if (v3 instanceof Just) {
              var chosenTree = v3.value0.spec(v2.value0);
              return renderNodeHelperWithDatum(dictOrd)(v)(chosenTree)(new Just(v2.value0));
            }
            ;
            if (v3 instanceof Nothing) {
              var doc = (function() {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1255, column 33 - line 1255, column 80): " + [v.constructor.name]);
              })();
              return function __do3() {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1245, column 3 - line 1257, column 42): " + [v3.constructor.name]);
          }
          ;
      ...
      return function(v1) {
        ...
        if (v1 instanceof Join) {
          return function __do3() {
            ...
            var doc2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1326, column 12 - line 1327, column 43): " + [v2.value0.update.constructor.name]);
            })();
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1352, column 19 - line 1354, column 45): " + [v3.constructor.name]);
            })();
        ...
        if (v1 instanceof NestedJoin) {
          return function __do3() {
            ...
            var v3 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1378, column 52 - line 1379, column 34): " + [v2.value0.enter.constructor.name]);
            })();
            var boundSel = new BoundSelection({
              elements,
              data: v3.pendingData,
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1394, column 19 - line 1396, column 45): " + [v4.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
        ...
        if (v1 instanceof UpdateJoin) {
          return function __do3() {
            var v2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1406, column 5 - line 1408, column 67): " + [v1.value0.keyFn.constructor.name]);
            })();
            ...
            (function() {
              if (v1.value0.behaviors.exit instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1440, column 7 - line 1448, column 20): " + [v1.value0.behaviors.exit.value0.transition.constructor.name]);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1438, column 3 - line 1452, column 16): " + [v1.value0.behaviors.exit.constructor.name]);
            })();
            var enterElementsAndMaps = (function() {
                ...
                (function() {
                  if (v1.value0.behaviors.enter.value0.transition instanceof Just) {
                    ...
                    var pendingData = (function() {
                      ...
                      ;
                      throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1481, column 41 - line 1482, column 54): " + [v2.value0.enter.constructor.name]);
                    })();
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1476, column 7 - line 1492, column 29): " + [v1.value0.behaviors.enter.value0.transition.constructor.name]);
                })();
                return rendered;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1463, column 27 - line 1497, column 68): " + [v1.value0.behaviors.enter.constructor.name]);
            })();
            var enterElements = map27(fst)(enterElementsAndMaps);
            var enterChildMaps = map27(snd)(enterElementsAndMaps);
            var updateElements = (function() {
              if (v1.value0.behaviors.update instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1506, column 7 - line 1522, column 71): " + [v1.value0.behaviors.update.value0.transition.constructor.name]);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1503, column 21 - line 1525, column 67): " + [v1.value0.behaviors.update.constructor.name]);
            })();
            var allElements = append14(enterElements)(updateElements);
            var combinedChildMap = foldl2(union5)(empty3)(enterChildMaps);
            var doc2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1539, column 12 - line 1540, column 43): " + [v2.value0.update.constructor.name]);
            })();
            var allData = (function() {
              if (v2.value0.enter instanceof PendingSelection) {
                return v2.value0.enter.value0.pendingData;
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1564, column 19 - line 1566, column 45): " + [v3.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
          ...
          return function __do3() {
            ...
            (function() {
              if (v1.value0.behaviors.exit instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1617, column 7 - line 1625, column 20): " + [v1.value0.behaviors.exit.value0.transition.constructor.name]);
              }
              ;
              if (v1.value0.behaviors.exit instanceof Nothing) {
                remove1(v2.value0.exit)();
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1615, column 3 - line 1628, column 16): " + [v1.value0.behaviors.exit.constructor.name]);
            })();
            var enterElementsAndMaps = (function() {
              if (v1.value0.behaviors.enter instanceof Just) {
                var modifiedTemplate = function(datum2) {
                ...
                (function() {
                  if (v1.value0.behaviors.enter.value0.transition instanceof Just) {
                    ...
                    var pendingData = (function() {
                      ...
                      ;
                      throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1661, column 41 - line 1662, column 54): " + [v2.value0.enter.constructor.name]);
                    })();
                    var pairs = zipWith(Tuple.create)(enterElements2)(pendingData);
                    return liftEffect3(traverseWithIndex_2(function(index5) {
                      return function(v4) {
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1656, column 7 - line 1672, column 29): " + [v1.value0.behaviors.enter.value0.transition.constructor.name]);
                })();
                return rendered;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1645, column 27 - line 1675, column 92): " + [v1.value0.behaviors.enter.constructor.name]);
            })();
            var updateElements = (function() {
              if (v1.value0.behaviors.update instanceof Just) {
                if (v1.value0.behaviors.update.value0.transition instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1681, column 7 - line 1694, column 86): " + [v1.value0.behaviors.update.value0.transition.constructor.name]);
              }
              ;
              if (v1.value0.behaviors.update instanceof Nothing) {
                return renderTemplatesForBoundSelection1(v1.value0.template)(v2.value0.update)();
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1678, column 21 - line 1695, column 91): " + [v1.value0.behaviors.update.constructor.name]);
            })();
            var enterElements = map27(fst)(enterElementsAndMaps);
            var allElements = append14(enterElements)(updateElements);
            var enterChildMaps = map27(snd)(enterElementsAndMaps);
            ...
            var doc2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1714, column 12 - line 1715, column 43): " + [v2.value0.update.constructor.name]);
            })();
            var boundSel = new BoundSelection({
              elements: allElements,
              data: innerData,
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1729, column 19 - line 1731, column 45): " + [v5.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
        ...
        if (v1 instanceof ConditionalRender) {
          var doc = (function() {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1745, column 29 - line 1745, column 76): " + [v.constructor.name]);
          })();
          return function __do3() {
            var dummyElement = createElementWithNS(Group.value)(doc)();
            return new Tuple(dummyElement, empty3);
        ...
        ;
        throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1265, column 1 - line 1270, column 74): " + [v.constructor.name, v1.constructor.name]);
      };
    };
  };
        ...
        return function(wrapperType) {
          return function(pendingSel) {
            var v = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1777, column 68 - line 1778, column 34): " + [pendingSel.constructor.name]);
            })();
            return traverseWithIndex3(function(idx) {
              return function(outerDatum) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1783, column 9 - line 1815, column 57): " + [v1.constructor.name]);
              };
            })(v.pendingData);
          };
        };
          ...
          return function(attrs) {
            return function(emptySelection) {
              return liftEffect12((function() {
                ...
                var dataArray = fromFoldable28(foldableData);
                ...
                return function(enterAttrs) {
                  return function(updateAttrs) {
                    return function(exitAttrs) {
                      return bind112(joinData4(foldableData)(selector)(emptySelection))(function(v) {
                        return bind112(bind112(append42(elemType)([])(v.value0.enter))(function(bound) {
                          ...
                          return bind112((function() {
                            ...
                            return discard23((function() {
                              ...
                              if (exitAttrs instanceof Just) {
                                return bind112(applyPerDatumAttrs1(exitAttrs.value0)(v.value0.exit))(function() {
                                  return remove22(v.value0.exit);
                                });
                              }
                              ;
  ...
  function bisector(f) {
    ...
    if (f.length !== 2) {
      ...
      compare22 = (d, x3) => ascending2(f(d), x3);
      delta = (d, x3) => f(d) - x3;
    } else {
      compare12 = f === ascending2 || f === descending ? f : zero3;
      compare22 = f;
      delta = f;
    }
  ...
  function ordinal() {
    ...
    function scale(d) {
      ...
      if (i2 === void 0) {
        ...
        index5.set(d, i2 = domain2.push(d) - 1);
      }
  ...
  function locale_default(locale3) {
    ...
    function newFormat(specifier) {
      ...
      var fill = specifier.fill, align2 = specifier.align, sign2 = specifier.sign, symbol = specifier.symbol, zero4 = specifier.zero, width8 = specifier.width, comma = specifier.comma, precision = specifier.precision, trim2 = specifier.trim, type = specifier.type;
      if (type === "n") comma = true, type = "g";
      else if (!formatTypes_default[type]) precision === void 0 && (precision = 12), trim2 = true, type = "g";
      if (zero4 || fill === "0" && align2 === "=") zero4 = true, fill = "0", align2 = "=";
      ...
      function format2(value13) {
        ...
        var length10 = valuePrefix.length + value13.length + valueSuffix.length, padding2 = length10 < width8 ? new Array(width8 - length10 + 1).join(fill) : "";
  ...
  function quantile2() {
    ...
    function scale(x3) {
      return x3 == null || isNaN(x3 = +x3) ? unknown : range5[bisect_default(thresholds, x3)];
    }
    scale.invertExtent = function(y3) {
      var i2 = range5.indexOf(y3);
      return i2 < 0 ? [NaN, NaN] : [
  ...
  function quantize() {
    var x0 = 0, x1 = 1, n = 1, domain2 = [0.5], range5 = [0, 1], unknown;
    function scale(x3) {
      return x3 != null && x3 <= x3 ? range5[bisect_default(domain2, x3, 0, n)] : unknown;
    }
    function rescale() {
      var i2 = -1;
      domain2 = new Array(n);
      while (++i2 < n) domain2[i2] = ((i2 + 1) * x1 - (i2 - n) * x0) / (n + 1);
      return scale;
    }
    scale.domain = function(_) {
    ...
    scale.invertExtent = function(y3) {
      var i2 = range5.indexOf(y3);
      return i2 < 0 ? [NaN, NaN] : i2 < 1 ? [x0, domain2[0]] : i2 >= n ? [domain2[n - 1], x1] : [domain2[i2 - 1], domain2[i2]];
    };
    scale.unknown = function(_) {
  ...
  function timeInterval(floori, offseti, count, field) {
    ...
    interval2.offset = (date2, step4) => {
      return offseti(date2 = /* @__PURE__ */ new Date(+date2), step4 == null ? 1 : Math.floor(step4)), date2;
    };
    interval2.range = (start4, stop2, step4) => {
      const range5 = [];
      start4 = interval2.ceil(start4);
      step4 = step4 == null ? 1 : Math.floor(step4);
      if (!(start4 < stop2) || !(step4 > 0)) return range5;
      let previous;
      do
        range5.push(previous = /* @__PURE__ */ new Date(+start4)), offseti(start4, step4), floori(start4);
    ...
    if (count) {
      interval2.count = (start4, end) => {
        t0.setTime(+start4), t1.setTime(+end);
        floori(t0), floori(t1);
        return Math.floor(count(t0, t1));
      };
      interval2.every = (step4) => {
        step4 = Math.floor(step4);
        return !isFinite(step4) || !(step4 > 0) ? null : !(step4 > 1) ? interval2 : interval2.filter(field ? (d) => field(d) % step4 === 0 : (d) => interval2.count(0, d) % step4 === 0);
      };
    }
    return interval2;
  }
  ...
  function ticker(year, month, week, day, hour, minute) {
    ...
    function tickInterval(start4, stop2, count) {
      const target6 = Math.abs(stop2 - start4) / count;
      const i2 = bisector(([, , step5]) => step5).right(tickIntervals, target6);
      if (i2 === tickIntervals.length) return year.every(tickStep(start4 / durationYear, stop2 / durationYear, count));
      if (i2 === 0) return millisecond.every(Math.max(tickStep(start4, stop2, count), 1));
    ...
    function parseSpecifier(d, specifier, string, j) {
      ...
      while (i2 < n) {
        ...
        if (c === 37) {
          ...
          if (!parse7 || (j = parse7(d, string, j)) < 0) return -1;
  ...
  var percentRe = /^%/;
  var requoteRe = /[\\^$*+?|[\]().{}]/g;
  function pad(value13, fill, width8) {
    var sign2 = value13 < 0 ? "-" : "", string = (sign2 ? -value13 : value13) + "", length10 = string.length;
    return sign2 + (length10 < width8 ? new Array(width8 - length10 + 1).join(fill) + string : string);
  }
  function requote(s) {
  ...
  // output/CE2.Data.ColorPalette/index.js
  ...
  var getPalette = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at CE2.Data.ColorPalette (line 86, column 1 - line 86, column 43): " + [v.constructor.name]);
  };
      ...
      return function(c) {
        ...
        if ($147) {
          ...
          if ($148) {
            ...
            var y3 = sqrt(max7(0)(b22 / d2 - x3 * x3));
            return {
              x: b10.x - x3 * dx - y3 * dy,
              y: b10.y - x3 * dy + y3 * dx,
              r: c.r
          ...
          var y3 = sqrt(max7(0)(a22 / d2 - x3 * x3));
          return {
            x: a2.x + x3 * dx - y3 * dy,
            y: a2.y + x3 * dy + y3 * dx,
            r: c.r
  ...
  var initState = function(c0) {
    return function(c1) {
      return function(c2) {
        ...
        var circles = fromFoldable19([new Tuple(0, c0$prime), new Tuple(1, c1$prime), new Tuple(2, c2$prime)]);
        return {
          circles,
          frontChain: [0, 2, 1],
          nextId: 3
  ...
  var enclosesWeak = function(a2) {
    return function(b10) {
      var dy = b10.y - a2.y;
      var dx = b10.x - a2.x;
      var dr = a2.r - b10.r + max7(a2.r)(max7(b10.r)(1)) * epsilon;
      return dr > 0 && dr * dr > dx * dx + dy * dy;
    };
  };
  ...
  var encloseBasis3 = function(a2) {
    return function(b10) {
      return function(c) {
        ...
        var xa = (b22 * d3 - b32 * d2) / (ab * 2) - a2.x;
  ...
  var encloseBasis = function(basis2) {
    ...
    if (v === 1) {
      return fromMaybe({
        ...
        y: 0,
        r: 0
      })(map111(encloseBasis1)(index(basis2)(0)));
    }
    ;
    if (v === 2) {
      return fromMaybe({
        ...
        y: 0,
        r: 0
      })(apply3(map111(encloseBasis2)(index(basis2)(0)))(index(basis2)(1)));
    }
    ;
    if (v === 3) {
      return fromMaybe({
        ...
        y: 0,
        r: 0
      })(apply3(apply3(map111(encloseBasis3)(index(basis2)(0)))(index(basis2)(1)))(index(basis2)(2)));
    }
    ;
    return {
      x: 0,
  ...
  var scoreNode = function(nodeId) {
    return function(state3) {
      return bind8(lookup7(nodeId)(state3.circles))(function(node) {
        return bind8(getNextId(nodeId)(state3.frontChain))(function(nextId) {
          return bind8(lookup7(nextId)(state3.circles))(function(next) {
            return pure10({
              nodeId,
    ...
    return function(bId) {
      return function(newCircle) {
        return function(state3) {
              ...
              return function($copy_sj) {
                return function($copy_sk) {
                  ...
                  function $tco_loop(j, k, sj, sk) {
                    var $215 = sj <= sk;
                    if ($215) {
                      var v4 = lookup7(j)(state3.circles);
                      if (v4 instanceof Just) {
                    ...
                    ;
                    var v4 = lookup7(k)(state3.circles);
                    if (v4 instanceof Just) {
          ...
          var v = lookup7(bId)(state3.circles);
          var v1 = lookup7(aId)(state3.circles);
          if (v1 instanceof Just && v instanceof Just) {
  ...
  var packSiblingsMap = function(inputCircles) {
    ...
    if (v2 instanceof Just && (v1 instanceof Just && v instanceof Just)) {
      ...
      var finalState = foldl9(flip(addCircle))(initialState2)(remaining);
      var positioned = mapMaybe(function(i2) {
        return lookup7(i2)(finalState.circles);
      })(range2(0)(n - 1 | 0));
  ...
  // output/CE2.Viz.NeighborhoodView/index.js
  ...
  var packRadiusIsSymbol = {
    reflectSymbol: function() {
      return "packRadius";
    }
  };
  var ordRecordCons1 = /* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons3({
    reflectSymbol: function() {
      return "y";
    }
  })(ordNumber))()({
  ...
  var ordRecord1 = /* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons1({
    reflectSymbol: function() {
      return "vy";
    }
  })(ordNumber))()({
  ...
  })(ordNumber))()(rIsSymbol)(ordNumber))()({
    reflectSymbol: function() {
      return "package";
    }
  })(ordString))()(packRadiusIsSymbol)(ordNumber))()({
    reflectSymbol: function() {
      return "orbitAngle";
    }
  })(ordNumber))()({
  ...
  var renderTree4 = /* @__PURE__ */ renderTree(selectionMD3v2Selection_D)(/* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons3({
    reflectSymbol: function() {
      return "nodes";
    }
  })(/* @__PURE__ */ ordArray(/* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons3(packRadiusIsSymbol)(ordNumber))()({
    reflectSymbol: function() {
      return "packCircles";
    }
  })(/* @__PURE__ */ ordArray(/* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons1(rIsSymbol)(ordNumber))()(nameIsSymbol)(ordString))()({
    reflectSymbol: function() {
      return "depth";
    }
  })(ordInt))()({
  ...
  })(/* @__PURE__ */ ordArray(/* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons3({
    reflectSymbol: function() {
      return "target";
    }
  })(ordRecord1))()({
  ...
  var pure11 = /* @__PURE__ */ pure(applicativeD3v2M);
  ...
  var simulationId2 = "neighborhood-force";
  var neighborhoodForces = /* @__PURE__ */ (function() {
    return setup("neighborhood")([withStrength($$static(0.7))(withDistance($$static(150))(link2("links"))), withStrength($$static(-300))(manyBody("charge")), withRadius(dynamic(function(v) {
      return v.packRadius;
    }))(collide("collide")), withStrength($$static(0.1))(positionX("forceX")), withStrength($$static(0.1))(positionY("forceY"))]);
  })();
  var groupByKind = function(decls) {
    var addToGroup = function(m) {
      return function(d) {
        return alter((function() {
          var $266 = maybe([d])(function(v) {
            return snoc(v)(d);
          });
          return function($267) {
            return Just.create($266($267));
          };
        })())(d.kind)(m);
      };
    };
    var kindMap = foldl2(addToGroup)(empty)(decls);
    var groups = foldMap4(function(k) {
      return function(ds) {
        return [{
          kind: k,
          decls: ds
  ...
  var getPackFill = function(pc) {
    ...
    ;
    if (pc.depth === 1) {
      return getCategoryColor(DeclarationTypes.value)(pc.name);
    }
    ;
    return getCategoryColor(DeclarationTypes.value)(pc.category);
  };
  var flattenPackNode = function(v) {
    return function(parentCategory) {
      var thisCategory = (function() {
        var $254 = v.value0.depth === 1;
        if ($254) {
      ...
      var childCircles = bind9(v.value0.children)(function(child) {
        return flattenPackNode(child)(thisCategory);
      });
      return append11([thisCircle])(childCircles);
    };
  };
  var createPackNodeTree = function(pn) {
    return withChildren(named(Group.value)("pack-node")([fnAttr3("transform")(function(v) {
      return "translate(" + (show6(pn.node.x) + ("," + (show6(pn.node.y) + ")")));
    }), fnAttrStr("class")(function(v) {
      return "pack-node-group";
    })]))(mapFlipped8(pn.packCircles)(function(pc) {
      return elem3(Circle.value)([fnAttr1("cx")(function(v) {
        return pc.x;
      }), fnAttr1("cy")(function(v) {
        return pc.y;
      }), fnAttr1("r")(function(v) {
        return pc.r;
      }), fnAttrStr("fill")(function(v) {
        return getPackFill(pc);
      }), fnAttrStr("stroke")(function(v) {
        var $256 = pc.depth === 0;
        if ($256) {
        ...
        ;
        return "none";
      }), fnAttr1("stroke-width")(function(v) {
        var $257 = pc.depth === 0;
        if ($257) {
          return 1.5;
        }
        ...
        return "pack-circle depth-" + show15(pc.depth);
      })]);
    }));
  };
  var createNodesTree = function(scene) {
    return withChild(named(Group.value)("neighborhood-nodes")([fnAttrStr("class")(function(v) {
      return "neighborhood-nodes-group";
    })]))(updateNestedJoin("nodes")("g")([scene])(function(v) {
      return v.nodes;
    })(createPackNodeTree)({
      enter: Nothing.value,
  ...
  var createLinkTree = function(_link) {
    return elem3(Line.value)([fnAttr1("x1")(function(v) {
      return v.source.x;
    }), fnAttr1("y1")(function(v) {
      return v.source.y;
    }), fnAttr1("x2")(function(v) {
      return v.target.x;
    }), fnAttr1("y2")(function(v) {
      return v.target.y;
    }), evalAttrStr("stroke")(str3("rgba(255,255,255,0.3)")), fnAttr1("stroke-width")(function(v) {
      return 1;
    }), fnAttrStr("class")(function(v) {
  ...
  var createLinksTree = function(scene) {
    return withChild(named(Group.value)("neighborhood-links")([fnAttrStr("class")(function(v) {
      return "neighborhood-links-group";
    })]))(updateNestedJoin("links")("line")([scene])(function(v) {
      return v.links;
    })(createLinkTree)({
      enter: Nothing.value,
      update: Nothing.value,
  ...
  var renderScene = function(containerSelector) {
    return function(scene) {
      return runD3v2M(bind14(select7(containerSelector))(function(svg) {
        var linksTree = createLinksTree(scene);
        return bind14(renderTree4(svg)(linksTree))(function() {
          var nodesTree = createNodesTree(scene);
          return bind14(renderTree4(svg)(nodesTree))(function() {
            return pure11(unit);
          });
        });
      }));
  ...
  var buildNeighborhoodLinks = function(nodes) {
    var nodeIds = fromFoldable20(map31(function(v) {
      return v.id;
    })(nodes));
    return bind9(nodes)(function(n) {
      return map31(function(targetId) {
        return {
          source: n.id,
          target: targetId
        };
      })(filter(function(targetId) {
        return member7(targetId)(nodeIds);
      })(n.targets));
    });
  };
  ...
  var computeModulePack = function(moduleName) {
    return function(decls) {
      var hierData = buildModuleHierarchy(moduleName)(decls);
      ...
      var allCircles = flattenPackNode(packed)("");
      var centerOffset = 200 / 2;
      var centeredCircles = mapFlipped8(allCircles)(function(c) {
        return {
          category: c.category,
          depth: c.depth,
          name: c.name,
      ...
      return {
        circles: centeredCircles,
        radius: packed.value0.r
      };
    };
  };
  var buildSceneData = function(currentNodes) {
    return function(links) {
      return function(declarations) {
        var rawLinks = mapFlipped8(links)(function(l) {
          return {
            source: l.source,
            target: l.target
          };
        });
        var packNodes = mapFlipped8(currentNodes)(function(n) {
          var decls = fromMaybe([])(lookup(n.name)(declarations));
          var packLayout = computeModulePack(n.name)(decls);
          return {
            node: n,
            packCircles: packLayout.circles,
            packRadius: n.packRadius
          };
        });
        var filteredLinks = filterLinksToSubset(function(v) {
          return v.node.id;
        })(packNodes)(rawLinks);
        var swizzledLinks = swizzleLinksByIndex(function(v) {
          return v.node.id;
        })(packNodes)(filteredLinks)(function(src9) {
          return function(tgt) {
            return function(i2) {
              return function(v) {
                return {
  ...
  var createSimulationWithCallbacks2 = function(callbacks) {
    return function(nodes) {
      return function(declarations) {
        return function __do3() {
          log8("[NeighborhoodView] Creating simulation with " + (show15(length(nodes)) + " nodes"))();
          var enrichedNodes = mapFlipped8(nodes)(function(n) {
            var decls = fromMaybe([])(lookup(n.name)(declarations));
            var packLayout = computeModulePack(n.name)(decls);
            var enrichedNode = {
              id: n.id,
              ...
              topoY: n.topoY,
              topoLayer: n.topoLayer,
              packRadius: packLayout.radius
            };
            return enrichedNode;
          });
          var v = createWithCallbacks(defaultConfig)(callbacks)();
          setNodes(enrichedNodes)(v)();
          var neighborhoodLinks = buildNeighborhoodLinks(enrichedNodes);
          setLinks(neighborhoodLinks)(v)();
          applySetup(neighborhoodForces)(v)();
          registerSimulation_(simulationId2)(reheat(v))();
          return v;
        };
      };
    };
  ...
  var fromFoldable21 = /* @__PURE__ */ fromFoldable3(ordInt)(foldableArray);
  ...
  var updatePositions = function(config) {
    return function(animState) {
      return function(layout) {
        ...
        var treeNodeMap = fromFoldable21(mapFlipped9(layout.treeNodes)(function(tn) {
          return new Tuple(tn.id, tn);
        }));
        return function __do3() {
          ...
          return classifyElements(config.containerSelector)("circle")(function(rect) {
            if (rect.simNode instanceof Just && member8(rect.simNode.value0.id)(inTreeIds)) {
              return "in-tree";
            }
            ;
            return "dimmed";
  ...
  var resetToTreemap = function(containerSelector) {
    return function __do3() {
      log9("[TreeView] Resetting to treemap positions")();
    ...
    return function(rootX) {
      return function(rootY) {
        return function(_el) {
          ...
          }), evalAttrStr("fill")(str4("none")), evalAttrStr("stroke")(str4("rgba(255, 255, 255, 0.5)")), fnAttr4("stroke-width")(function(v) {
            return 1.5;
          }), fnAttrStr("class")(function(v) {
            return "tree-link";
          })]);
  ...
  var buildTreeNodeMap2 = function(nodes) {
    return fromFoldable21(mapFlipped9(nodes)(function(n) {
      return new Tuple(n.id, n);
    }));
  };
  ...
  var buildLinkElement2 = function(nodeMap) {
    return function(rootX) {
      return function(rootY) {
        return function(v) {
          return bind10(lookup8(v.value0)(nodeMap))(function(sourceNode) {
            return bind10(lookup8(v.value1)(nodeMap))(function(targetNode) {
              return pure12({
    ...
    return function(layout) {
      return function(rootX) {
        return function(rootY) {
          ...
          return function __do3() {
            log9("[TreeView] Adding " + (show7(length(linkElements)) + " tree links"))();
  ...
  var renderAnimated = function(config) {
    return function(animState) {
      return function(nodes) {
        return function(links) {
          return function __do3() {
            log9("[TreeView] renderAnimated called, isFirstFrame=" + (show16(animState.isFirstFrame) + (", progress=" + show24(animState.progress))))();
            var layout = (function() {
              if (animState.treeLayout instanceof Just) {
                log9("[TreeView] Using cached layout")();
                return animState.treeLayout.value0;
              }
              ;
              if (animState.treeLayout instanceof Nothing) {
                log9("[TreeView] Computing tree layout...")();
                log9("[TreeView] Using root: " + show7(config.rootId))();
                var result = computeTreeLayout(config.style)(config.rootId)(nodes)(links);
                log9("[TreeView] Layout computed: root=" + (show7(result.rootId) + (" at (" + (show24(result.rootX) + (", " + (show24(result.rootY) + (")" + (", " + (show7(length(result.treeNodes)) + " nodes")))))))))();
                return result;
              }
              ;
            ...
            (function() {
              if (animState.isFirstFrame) {
                log9("[TreeView] First frame - root at (" + (show24(layout.rootX) + (", " + (show24(layout.rootY) + ")"))))();
  ...
  var sum2 = function(v) {
    return function(valueAccessor) {
      ...
      var childrenSum = foldl10(function(acc) {
        return function(child) {
      ...
      return function(y0) {
        return function(x1) {
          return function(y1) {
            ...
            var positioned = foldl11(function(acc) {
              return function(child) {
  ...
  var fnAttr5 = /* @__PURE__ */ fnAttr(showNumber);
  ...
  var fromFoldable26 = /* @__PURE__ */ fromFoldable4(foldableArray)(ordInt);
  var member9 = /* @__PURE__ */ member2(ordInt);
  ...
  var ordRecordCons4 = /* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(ordRecordNil)()({
    reflectSymbol: function() {
      return "y";
    }
  })(ordNumber))()({
  ...
  var renderTree6 = /* @__PURE__ */ renderTree(selectionMD3v2Selection_D)(/* @__PURE__ */ ordRecord4(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons4({
    reflectSymbol: function() {
      return "width";
    }
  })(ordNumber))()({
  ...
  })(/* @__PURE__ */ ordMaybe(/* @__PURE__ */ ordRecord4(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons4({
    reflectSymbol: function() {
      return "vy";
    }
  })(ordNumber))()({
  ...
  })(ordNodeType))()(nameIsSymbol2)(ordString))()({
    reflectSymbol: function() {
      return "isInTree";
    }
  })(ordBoolean))()({
  ...
  })(ordNullable3))()(clusterIsSymbol)(ordInt)))))()(nameIsSymbol2)(ordString))()({
    reflectSymbol: function() {
      return "isUsed";
    }
  })(ordBoolean))()({
  ...
  var packageRectTemplate = function(callbacks) {
    return function(_rect) {
      return withBehaviors(elem3(Rect.value)([fnAttr5("x")(function(v) {
        return v.x;
      }), fnAttr5("y")(function(v) {
        return v.y;
      }), fnAttr5("width")(function(v) {
        return v.width;
      }), fnAttr5("height")(function(v) {
        return v.height;
      }), evalAttrStr("fill")(str5("none")), evalAttrStr("stroke")(str5("rgba(255, 255, 255, 0.3)")), fnAttr5("stroke-width")(function(v) {
        return 1;
      }), evalAttrStr("pointer-events")(str5("all")), fnAttrStr("class")(function(v) {
        return "package-rect";
  ...
  var packageLabelTemplate = function(_rect) {
    return elem3(Text.value)([fnAttr5("x")(function(r) {
      return r.x + 4;
    }), fnAttr5("y")(function(r) {
      return r.y + 12;
    }), evalAttrStr("fill")(str5("rgba(255, 255, 255, 0.5)")), evalAttrStr("font-size")(str5("10px")), evalAttrStr("font-family")(str5("monospace")), fnAttrStr("class")(function(v) {
  ...
  var moduleCircleTemplate = function(callbacks) {
    return function(_node) {
      return withBehaviors(elem3(Circle.value)([fnAttr5("cx")(function(r) {
        return r.x + r.width / 2;
      }), fnAttr5("cy")(function(r) {
        return r.y + r.height / 2;
      }), fnAttr5("r")(function(r) {
        return min8(r.width)(r.height) / 2 * 0.8;
      }), evalAttrStr("fill")(str5("#0E4C8A")), fnAttrStr("stroke")(function(r) {
        if (r.isUsed) {
          return "rgba(255, 255, 255, 0.7)";
        }
        ;
        return "black";
      }), fnAttr5("stroke-width")(function(r) {
        if (r.isUsed) {
          return 1;
        }
        ;
  ...
  var highlightDependencies = function(containerSelector) {
    return function(node) {
      return function __do3() {
        log10("[Treemap] Highlighting dependencies for: " + node.name)();
        log10("[Treemap]   nodeType: " + (function() {
        ...
        log10("[Treemap]   targets (depends on): " + show8(node.targets))();
        log10("[Treemap]   sources (depended on by): " + show8(node.sources))();
        var targetSet = fromFoldable26(node.targets);
        var sourceSet = fromFoldable26(node.sources);
        var classifier = function(rect) {
          ...
          if (rect.simNode instanceof Just) {
            ...
            ;
            var $215 = member9(rect.simNode.value0.id)(targetSet);
            if ($215) {
              return "is-target";
            }
            ;
            var $216 = member9(rect.simNode.value0.id)(sourceSet);
            if ($216) {
              return "is-source";
            }
            ;
  ...
  var computeTreemapLayout = function(_config) {
    return function(packageNodes) {
      return function(moduleNodes) {
        ...
        var modulesByPackage = (function() {
          var addModule = function(acc) {
            return function(mod6) {
              var existing = fromMaybe([])(lookup9(mod6["package"])(acc));
              return insert11(mod6["package"])(snoc(existing)(mod6))(acc);
            };
          };
          return foldl12(addModule)(empty3)(moduleNodes);
        })();
        var getChildren2 = function(leaf) {
          if (leaf.name === "root") {
            return new Just(mapFlipped10(packageNodes)(function(pkg) {
              return {
                name: pkg.name,
                nodeType: PackageNode.value,
                loc: 0,
          ...
          if (leaf.nodeType instanceof PackageNode) {
            ...
            ;
            return new Just(mapFlipped10(mods)(function(mod6) {
              return {
                name: mod6.name,
                nodeType: ModuleNode.value,
                loc: mod6.r * mod6.r,
                simNode: new Just(mod6),
                cluster: mod6.cluster
              };
            }));
          }
          ;
        ...
        var hier = hierarchy2(rootData)(getChildren2);
        ...
        var extractPositions = function(v) {
          ...
          var processChildren = function(children3) {
            return function(acc) {
              return foldl12(processNode)(acc)(children3);
            };
          };
  ...
  var clearHighlight = function(containerSelector) {
    return function __do3() {
      log10("[Treemap] Clearing highlights")();
  ...
  var buildVizTree = function(_config) {
    return function(callbacks) {
      return function(positioned) {
        ...
        return withChildren(named(SVG.value)("root")([evalAttrStr("viewBox")(str5("-950 -570 1900 1140")), fnAttrStr("class")(function(v) {
          return "treemap-svg";
        ...
        })]))(joinData("module-circles")("circle")(map34(toPackageRect)(positioned.modules))(moduleCircleTemplate(callbacks)))]);
      };
    };
  };
  var render2 = function(config) {
    return function(callbacks) {
      return function(nodes) {
        return function __do3() {
          log10("[Treemap] Rendering " + (show17(length(nodes)) + " nodes"))();
          ...
          log10("[Treemap] Packages: " + (show17(length(packageNodes)) + (", Modules: " + show17(length(moduleNodes)))))();
          var positioned = computeTreemapLayout(config)(packageNodes)(moduleNodes);
          log10("[Treemap] Positioned: " + (show17(length(positioned.packages)) + (" packages, " + (show17(length(positioned.modules)) + " modules"))))();
          var vizTree = buildVizTree(config)(callbacks)(positioned);
          runD3v2M(bind15(select9(config.containerSelector))(function(container) {
            return renderTree6(container)(vizTree);
          }))();
          return log10("[Treemap] Render complete")();
        };
      };
    };
  };
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Elem) {
        return new Elem(v2.value0, v2.value1, v.value0(v2.value2), map35(go2)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map35(map112(go2))(v2.value3));
      }
      ;
  ...
  var create4 = function __do() {
    ...
    return {
      ...
      listener: function(a2) {
        return bind11(read(subscribers))(traverse_1(function(k) {
          return k(a2);
        }));
      }
    };
  ...
  var fork = function(hmu) {
    return liftF(new Fork(hmu, identity16));
  };
  ...
  var defaultCallbacks = function __do2() {
    ...
    var startRef = $$new(pure15(unit))();
    var stopRef = $$new(pure15(unit))();
  ...
  var mapFlipped11 = /* @__PURE__ */ mapFlipped(functorEmitter);
  ...
  var log11 = /* @__PURE__ */ log3(monadEffectEffect);
  ...
  var fromFoldable111 = /* @__PURE__ */ fromFoldable4(foldableArray)(ordInt);
  ...
  var ShowNeighborhood = /* @__PURE__ */ (function() {
    function ShowNeighborhood2(value0) {
      this.value0 = value0;
    }
    ;
    ShowNeighborhood2.create = function(value0) {
      return new ShowNeighborhood2(value0);
    };
    return ShowNeighborhood2;
  })();
  var NeighborhoodSimTick = /* @__PURE__ */ (function() {
    function NeighborhoodSimTick2() {
    }
    ;
    NeighborhoodSimTick2.value = new NeighborhoodSimTick2();
    return NeighborhoodSimTick2;
  })();
  var ExitNeighborhood = /* @__PURE__ */ (function() {
    function ExitNeighborhood2() {
    }
    ;
    ExitNeighborhood2.value = new ExitNeighborhood2();
    return ExitNeighborhood2;
  })();
  var startForceSimulation = function(dictMonadAff) {
    ...
    return function(layout) {
      return function(model) {
        return discard1(log1("[App] Creating force simulation with Halogen callbacks"))(function() {
          return bind16(liftEffect9(defaultCallbacks))(function(callbacks) {
            return bind16(liftEffect9(createSimulationWithCallbacks(callbacks)(layout)(model.nodes)(model.links)))(function(sim) {
              return bind16(liftEffect9(subscribeToSimulation(sim)))(function(emitter) {
                return discard1($$void6(subscribe2(mapFlipped11(emitter)(function(event) {
                  ...
                  return discard1(liftEffect9(start(sim)))(function() {
                    return discard1(modify_3(function(v) {
                      var $113 = {};
                      for (var $114 in v) {
                      ...
                      ;
                      $113.forcePhase = new Just(ForceActive.value);
                      $113.forceProgress = 0;
                      $113.simulation = new Just(sim);
                      return $113;
                    }))(function() {
                      return log1("[App] Force simulation started and subscribed");
                    });
                  });
                });
              });
  ...
  var showPhase = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at CE2.Component.App (line 259, column 1 - line 259, column 32): " + [v.constructor.name]);
  };
  var showForcePhase = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 62, column 1 - line 65, column 35): " + [v.constructor.name]);
    }
  };
    ...
    return {
      onNodeClick: function(node) {
        if (mListener instanceof Just) {
          return notify(mListener.value0)(new ShowNeighborhood(node.id));
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 783, column 27 - line 785, column 27): " + [mListener.constructor.name]);
      },
      onNodeHover: function(mNode) {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 786, column 28 - line 788, column 27): " + [mListener.constructor.name]);
      }
    };
  };
  ...
  var render3 = function(dictMonadAff) {
    return function(state3) {
      return div3([class_("explorer-app")])([div3([class_("status-panel")])([h2_([text5("Code Explorer v2")]), p_([text5("Phase: " + showPhase(state3.phase))]), p_([text5("View: " + viewDescription(state3.viewState))]), (function() {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 209, column 11 - line 211, column 34): " + [state3.forcePhase.constructor.name]);
      })(), (function() {
        ...
        if (state3.modelData instanceof Just) {
          return p_([text5("Loaded: " + (show9(state3.modelData.value0.moduleCount) + (" modules, " + (show9(state3.modelData.value0.packageCount) + " packages"))))]);
        }
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 212, column 11 - line 217, column 16): " + [state3.modelData.constructor.name]);
      })(), div3([class_("view-switcher")])([button2([onClick(function(v) {
        return SwitchToTreemap.value;
      }), class_((function() {
        var $133 = isTreemapView(state3.viewState);
        if ($133) {
          return "active";
        }
        ;
        ...
        var $134 = isTreeView(state3.viewState);
        if ($134) {
          return "active";
        }
        ;
        ...
        var $135 = isForceView(state3.viewState);
        if ($135) {
          return "active";
        }
        ;
  ...
  var initialState = function(v) {
    return {
      ...
      neighborhoodState: Nothing.value,
      declarations: Nothing.value,
  ...
  var findPackageOfNode = function(nodeId) {
    return function(nodes) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 794, column 3 - line 796, column 25): " + [v.constructor.name]);
    };
  };
  var cleanupForceSimulation = function(dictMonadAff) {
    ...
    var liftEffect9 = liftEffect(monadEffectHalogenM2);
    var log1 = log3(monadEffectHalogenM2);
    return bind16(get6)(function(state3) {
      if (state3.simulation instanceof Just) {
        return discard1(liftEffect9(cleanupSimulation(state3.simulation.value0)))(function() {
          return log1("[App] Force simulation cleaned up");
        });
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 728, column 3 - line 732, column 25): " + [state3.simulation.constructor.name]);
    });
  };
  var cleanupAnySimulation = function(dictMonadAff) {
    var liftEffect9 = liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()));
    return bind16(get6)(function(state3) {
      if (state3.simulation instanceof Just) {
        return liftEffect9(function __do3() {
          stop(state3.simulation.value0)();
          (function() {
            if (state3.viewState instanceof Overview && state3.viewState.value0 instanceof ForceView) {
              return unregisterSimulation_(simulationId)();
            }
            ;
            if (state3.viewState instanceof Detail && state3.viewState.value0 instanceof NeighborhoodDetail) {
              return unregisterSimulation_(simulationId2)();
            }
            ;
            return unit;
          })();
          return log11("[App] Simulation cleaned up")();
        });
      }
      ;
      if (state3.simulation instanceof Nothing) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 741, column 3 - line 751, column 25): " + [state3.simulation.constructor.name]);
    });
  };
  var animationDelta = 0.02;
  var startForceAnimationLoop = function(dictMonadAff) {
    return $$void6(fork(discard1(liftAff(monadAffHalogenM(dictMonadAff))(delay(16)))(function() {
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var cleanupAnySimulation1 = cleanupAnySimulation(dictMonadAff);
    return function(v) {
      if (v instanceof Initialize2) {
        return discard1(log1("[App] Initializing..."))(function() {
          return bind16(liftEffect9(create4))(function(v1) {
            return discard1($$void6(subscribe2(v1.emitter)))(function() {
              return discard1(modify_3(function(v2) {
                ...
                ;
                $162.clickEmitter = new Just(v1.listener);
                return $162;
              }))(function() {
                return $$void6(fork(bind16(liftAff2(loadModel))(function(result) {
                  if (result instanceof Left) {
                  ...
                  ;
                  throw new Error("Failed pattern match at CE2.Component.App (line 293, column 7 - line 295, column 57): " + [result.constructor.name]);
                })));
              });
            });
          });
      ...
      if (v instanceof DataLoaded) {
        return discard1(log1("[App] Data loaded: " + (show9(v.value0.moduleCount) + " modules")))(function() {
          return bind16(get6)(function(state3) {
            return discard1(modify_3(function(v1) {
              ...
              ;
              $170.phase = Ready.value;
              $170.modelData = new Just(v.value0);
              $170.packageCount = v.value0.packageCount;
              return $170;
            }))(function() {
              var config = {
              ...
              return discard1(liftEffect9(render2(config)(callbacks)(v.value0.nodes)))(function() {
                return log1("[App] Treemap rendered");
              });
            });
          });
        });
      ...
      if (v instanceof DataFailed) {
        return discard1(log1("[App] Data load failed: " + v.value0))(function() {
      ...
      if (v instanceof SwitchToTreemap) {
        return discard1(log1("[App] Switching to Treemap view"))(function() {
          return bind16(get6)(function(state3) {
            return discard1(cleanupForceSimulation1)(function() {
              if (state3.modelData instanceof Nothing) {
                return pure17(unit);
              }
              ;
              if (state3.modelData instanceof Just) {
                return discard1(modify_3(function(v1) {
                  ...
                  ;
                  $179.viewState = new Overview(TreemapView.value);
                  $179.treeAnimation = Nothing.value;
                  $179.treeRootId = Nothing.value;
                  $179.forcePhase = Nothing.value;
                  $179.forceLayout = Nothing.value;
                  $179.simulation = Nothing.value;
                  return $179;
                }))(function() {
                  var config = {
                    containerSelector: "#viz",
                  ...
                  var callbacks = makeTreemapCallbacks(state3.clickEmitter);
                  return discard1(liftEffect9(render2(config)(callbacks)(state3.modelData.value0.nodes)))(function() {
                    return log1("[App] Treemap rendered");
                  });
                });
              }
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 331, column 5 - line 354, column 37): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ...
      if (v instanceof SwitchToTree) {
        return discard1(log1("[App] SwitchToTree clicked"))(function() {
          return bind16(get6)(function(state3) {
            return discard1(cleanupForceSimulation1)(function() {
              if (state3.modelData instanceof Nothing) {
                return log1("[App] No model data, skipping");
              }
              ;
              if (state3.modelData instanceof Just) {
                return discard1(log1("[App] Initializing animation state"))(function() {
                  ...
                  return discard1(modify_3(function(v1) {
                    ...
                    ;
                    $184.viewState = new Overview(TreeView.value);
                    $184.treeAnimation = new Just(initAnimation);
                    $184.treeRootId = new Just(rootId);
                    $184.treeStyle = verticalTree;
                    $184.forcePhase = Nothing.value;
                    $184.forceLayout = Nothing.value;
                    $184.simulation = Nothing.value;
                    return $184;
                  }))(function() {
                    return discard1(log1("[App] Starting animation loop"))(function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 362, column 5 - line 379, column 27): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ...
      if (v instanceof SwitchToForce) {
        return discard1(log1("[App] SwitchToForce clicked"))(function() {
          return bind16(get6)(function(state3) {
            return discard1(cleanupForceSimulation1)(function() {
              if (state3.modelData instanceof Nothing) {
                return log1("[App] No model data, skipping");
              ...
              ;
              if (state3.modelData instanceof Just) {
                return discard1(log1("[App] Starting force animation (radial tree growth)"))(function() {
                  var rootId = findRootModule(state3.modelData.value0.nodes);
                  var layout = computeLayout(rootId)(state3.modelData.value0.nodes)(state3.modelData.value0.links);
                  return discard1(log1("[App] Layout computed: " + (show9(length(layout.treeNodes)) + " nodes in tree")))(function() {
                    return discard1(liftEffect9(addTreeLinks("#viz")(layout)))(function() {
                      return discard1(modify_3(function(v1) {
                        var $189 = {};
                        for (var $190 in v1) {
                        ...
                        ;
                        $189.viewState = new Overview(ForceView.value);
                        $189.treeAnimation = Nothing.value;
                        $189.treeRootId = Nothing.value;
                        $189.forcePhase = new Just(TreeGrowth.value);
                        $189.forceProgress = 0;
                        $189.forceLayout = new Just(layout);
                        $189.simulation = Nothing.value;
                        return $189;
                      }))(function() {
                        return discard1(log1("[App] Starting force animation loop (phase 1: TreeGrowth)"))(function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 387, column 5 - line 411, column 32): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ...
      if (v instanceof FocusSubtree) {
        return discard1(log1("[App] FocusSubtree on node " + show9(v.value0)))(function() {
          return bind16(get6)(function(state3) {
            return discard1(cleanupForceSimulation1)(function() {
              if (state3.modelData instanceof Nothing) {
                return pure17(unit);
              ...
              ;
              if (state3.modelData instanceof Just) {
                return discard1(liftEffect9(resetToTreemap("#viz")))(function() {
                  return discard1(modify_3(function(v1) {
                    var $194 = {};
                    for (var $195 in v1) {
                    ...
                    ;
                    $194.viewState = new Overview(TreeView.value);
                    $194.treeAnimation = new Just(initAnimation);
                    $194.treeRootId = new Just(v.value0);
                    $194.treeStyle = horizontalTree;
                    $194.forcePhase = Nothing.value;
                    $194.forceLayout = Nothing.value;
                    $194.simulation = Nothing.value;
                    return $194;
                  }))(function() {
                    return discard1(log1("[App] Starting horizontal subtree animation"))(function() {
                      return startAnimationLoop(dictMonadAff);
                    });
                  });
                });
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 421, column 5 - line 439, column 27): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ...
      if (v instanceof AnimationTick) {
        return bind16(get6)(function(state3) {
          if (state3.treeAnimation instanceof Just && (state3.modelData instanceof Just && (state3.treeRootId instanceof Just && isAnimating(state3.treeAnimation.value0)))) {
            ...
            return bind16(liftEffect9(renderAnimated(config)(state3.treeAnimation.value0)(state3.modelData.value0.nodes)(state3.modelData.value0.links)))(function(animWithLayout) {
              ...
              return discard1(modify_3(function(v1) {
                ...
                ;
                $202.treeAnimation = new Just(newAnim);
                return $202;
              }))(function() {
      ...
      if (v instanceof ForceAnimationTick) {
        return bind16(get6)(function(state3) {
          if (state3.forcePhase instanceof Just && (state3.forceLayout instanceof Just && state3.modelData instanceof Just)) {
            var newProgress = min9(1)(state3.forceProgress + animationDelta);
            if (state3.forcePhase.value0 instanceof TreeGrowth) {
              return discard1(liftEffect9(renderTreeGrowthPhase("#viz")(state3.forceLayout.value0)(state3.forceProgress)))(function() {
                var $212 = newProgress >= 1;
                if ($212) {
                  return discard1(log1("[App] Phase 1 complete, transitioning to LinkMorph"))(function() {
                    return discard1(modify_3(function(v1) {
                      var $213 = {};
                      for (var $214 in v1) {
                      ...
                      ;
                      $213.forcePhase = new Just(LinkMorph.value);
                      $213.forceProgress = 0;
                      return $213;
                    }))(function() {
                      return startForceAnimationLoop(dictMonadAff);
            ...
            if (state3.forcePhase.value0 instanceof LinkMorph) {
              return discard1(liftEffect9(renderLinkMorphPhase("#viz")(state3.forceLayout.value0)(state3.forceProgress)))(function() {
                var $219 = newProgress >= 1;
                if ($219) {
                  return discard1(log1("[App] Phase 2 complete, transitioning to ForceActive"))(function() {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Component.App (line 472, column 9 - line 502, column 22): " + [state3.forcePhase.value0.constructor.name]);
          }
          ;
          return pure17(unit);
        });
      ...
      if (v instanceof ForceSimTick) {
        return bind16(get6)(function(state3) {
          if (state3.simulation instanceof Just && (state3.forcePhase instanceof Just && state3.forcePhase.value0 instanceof ForceActive)) {
            return bind16(liftEffect9(getNodes(state3.simulation.value0)))(function(currentNodes) {
      ...
      if (v instanceof ToggleForceProjectOnly) {
        return discard1(log1("[App] Toggling force project-only filter"))(function() {
          return bind16(get6)(function(state3) {
            if (state3.simulation instanceof Just && (state3.modelData instanceof Just && state3.forceLayout instanceof Just)) {
              ...
              var nodeIds = fromFoldable27(map37(function(v1) {
                return v1.id;
              })(filteredNodes));
              var filteredLinks = filter(function(l) {
                return elem4(l.source)(nodeIds) && elem4(l.target)(nodeIds);
              })(state3.modelData.value0.links);
              return discard1(log1("[App] Project-only: " + (show18(newProjectOnly) + (" -> " + (show9(length(filteredNodes)) + (" nodes, " + (show9(length(filteredLinks)) + " links")))))))(function() {
                var rootId1 = findRootModule(filteredNodes);
                var newLayout = computeLayout(rootId1)(filteredNodes)(filteredLinks);
                return discard1(liftEffect9(addTreeLinks("#viz")(newLayout)))(function() {
                  return bind16(liftEffect9(defaultCallbacks))(function(callbacks) {
                    return bind16(liftEffect9(createSimulationWithCallbacks(callbacks)(newLayout)(filteredNodes)(filteredLinks)))(function(newSim) {
                      return bind16(liftEffect9(subscribeToSimulation(newSim)))(function(emitter) {
                        return discard1($$void6(subscribe2(mapFlipped11(emitter)(function(event) {
                          if (event instanceof Tick) {
                            return ForceSimTick.value;
                          }
                          ...
                          return discard1(liftEffect9(start(newSim)))(function() {
                            return discard1(liftEffect9(cleanupSimulation(state3.simulation.value0)))(function() {
                              return modify_3(function(v1) {
                                var $235 = {};
                                for (var $236 in v1) {
                                ...
                                ;
                                $235.forceShowProjectOnly = newProjectOnly;
                                $235.forceLayout = new Just(newLayout);
                                $235.simulation = new Just(newSim);
                                return $235;
                              });
                            });
                          });
        ...
        return bind16(get6)(function(state3) {
          ...
          if (state3.viewState instanceof Overview && state3.viewState.value0 instanceof TreemapView) {
            if (v.value0 instanceof Just) {
              return discard1(modify_3(function(v1) {
                ...
                ;
                $245.highlightState = new HoverHighlight(v.value0.value0.id);
                return $245;
              }))(function() {
            ...
            if (v.value0 instanceof Nothing) {
              return discard1(modify_3(function(v1) {
                ...
                ;
                $249.highlightState = NoHighlight.value;
                return $249;
              }))(function() {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Component.App (line 588, column 9 - line 594, column 55): " + [v.value0.constructor.name]);
          }
          ;
          if (v.value0 instanceof Just) {
            return discard1(modify_3(function(v1) {
              ...
              ;
              $254.highlightState = new HoverHighlight(v.value0.value0.id);
              return $254;
            }))(function() {
              return liftEffect9(highlightDependencies("#viz")(v.value0.value0));
            });
          ...
          if (v.value0 instanceof Nothing) {
            return discard1(modify_3(function(v1) {
              ...
              ;
              $258.highlightState = NoHighlight.value;
              return $258;
            }))(function() {
              return liftEffect9(clearHighlight("#viz"));
            });
          ...
          ;
          throw new Error("Failed pattern match at CE2.Component.App (line 597, column 9 - line 603, column 55): " + [v.value0.constructor.name]);
        });
      }
      ;
      if (v instanceof ShowNeighborhood) {
        return discard1(log1("[App] ShowNeighborhood: " + show9(v.value0)))(function() {
          return bind16(get6)(function(state3) {
            return discard1(cleanupAnySimulation1)(function() {
              if (state3.modelData instanceof Nothing) {
                return pure17(unit);
              }
              ;
              if (state3.modelData instanceof Just) {
                ...
                ;
                if (v1 instanceof Just) {
                  var depIds = fromFoldable111(v1.value0.targets);
                  var neighborhood = filter(function(n) {
                    return n.id === v.value0 || member10(n.id)(depIds);
                  })(state3.modelData.value0.nodes);
                  return discard1(log1("[App] Neighborhood: " + (show9(length(neighborhood)) + " modules")))(function() {
                    return $$void6(fork((function() {
                      var moduleNames = map37(function(v2) {
                        return v2.name;
                      })(neighborhood);
                      return bind16(liftAff2(fetchBatchDeclarations(moduleNames)))(function(result) {
                        if (result instanceof Left) {
                          return log1("[App] Fetch error: " + result.value0);
                        }
                        ;
                        if (result instanceof Right) {
                          return discard1(liftEffect9(log11("[App] Fetched " + (show9(size(result.value0)) + " modules"))))(function() {
                            return bind16(liftEffect9(defaultCallbacks))(function(callbacks) {
                              return bind16(liftEffect9(createSimulationWithCallbacks2(callbacks)(neighborhood)(result.value0)))(function(sim) {
                                return bind16(liftEffect9(subscribeToSimulation(sim)))(function(emitter) {
                                  return discard1($$void6(subscribe2(mapFlipped11(emitter)(function(v2) {
                                    return NeighborhoodSimTick.value;
                                  }))))(function() {
                                    return discard1(liftEffect9(start(sim)))(function() {
                                      return modify_3(function(v2) {
                                        ...
                                        ;
                                        $266.viewState = new Detail(new NeighborhoodDetail(v1.value0.name, BubblePackView.value));
                                        $266.neighborhoodState = new Just({
                                          focusedModuleId: v.value0,
                                          neighborhoodNodes: neighborhood
                                        });
                                        $266.declarations = new Just(result.value0);
                                        $266.simulation = new Just(sim);
                                        return $266;
                                      });
                                    });
                                  });
                        ...
                        ;
                        throw new Error("Failed pattern match at CE2.Component.App (line 630, column 15 - line 656, column 22): " + [result.constructor.name]);
                      });
                    })()));
                  });
                }
                ;
                throw new Error("Failed pattern match at CE2.Component.App (line 616, column 9 - line 656, column 22): " + [v1.constructor.name]);
              }
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 612, column 5 - line 656, column 22): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ;
      if (v instanceof NeighborhoodSimTick) {
        return bind16(get6)(function(state3) {
          if (state3.simulation instanceof Just && (state3.declarations instanceof Just && state3.modelData instanceof Just)) {
            return bind16(liftEffect9(getNodes(state3.simulation.value0)))(function(currentNodes) {
              var sceneData = buildSceneData(currentNodes)(state3.modelData.value0.links)(state3.declarations.value0);
              return liftEffect9(renderScene("#viz")(sceneData));
            });
          }
          ;
          return pure17(unit);
      ...
      ;
      if (v instanceof ExitNeighborhood) {
        return discard1(cleanupAnySimulation1)(function() {
          return discard1(modify_3(function(v1) {
            var $279 = {};
            for (var $280 in v1) {
            ...
            ;
            $279.viewState = new Overview(TreemapView.value);
            $279.neighborhoodState = Nothing.value;
            $279.declarations = Nothing.value;
            return $279;
          }))(function() {
            return handleAction(dictMonadAff)(SwitchToTreemap.value);
          });
        });
      }
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 281, column 16 - line 682, column 33): " + [v.constructor.name]);
    };
  };
  ...
  var selectElement = function(query2) {
    return bind17(liftEffect4(bindFlipped5(composeKleisliFlipped4((function() {
  ...
  var insert14 = /* @__PURE__ */ insert3(ordSubscriptionId);
  var retractFreeAp2 = /* @__PURE__ */ retractFreeAp(applicativeParAff);
  var $$delete8 = /* @__PURE__ */ $$delete4(ordForkId);
  var unlessM2 = /* @__PURE__ */ unlessM(monadEffect);
  var insert15 = /* @__PURE__ */ insert3(ordForkId);
  var traverse_32 = /* @__PURE__ */ traverse_12(foldableMaybe);
  var lookup12 = /* @__PURE__ */ lookup2(ordForkId);
  var lookup22 = /* @__PURE__ */ lookup2(ordString);
  var foldFree2 = /* @__PURE__ */ foldFree(monadRecAff);
  var alter4 = /* @__PURE__ */ alter2(ordString);
  ...
  var queueOrRun = function(ref2) {
    return function(au) {
      return bind18(liftEffect5(read(ref2)))(function(v) {
        if (v instanceof Nothing) {
          return au;
        }
        ;
  ...
  var handleLifecycle = function(lchs) {
    return function(f) {
      return discard12(liftEffect5(write({
        ...
        return bind18(liftEffect5(f))(function(result) {
          return bind18(liftEffect5(read(lchs)))(function(v) {
  ...
  var evalQ = function(render4) {
    return function(ref2) {
      return function(q2) {
        return bind18(liftEffect5(read(ref2)))(function(v) {
          return evalM(render4)(ref2)(v["component"]["eval"](new Query(map40(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
    ...
    return function(initRef) {
      return function(v) {
        var evalChildQuery = function(ref2) {
          return function(cqb) {
            return bind18(liftEffect5(read(ref2)))(function(v1) {
              return unChildQueryBox(function(v2) {
                var evalChild = function(v3) {
                  return parallel3(bind18(liftEffect5(read(v3)))(function(dsx) {
                    return unDriverStateX(function(ds) {
                      return evalQ(render4)(ds.selfRef)(v2.value1);
                    })(dsx);
                  }));
                };
                return map113(v2.value2)(sequential3(v2.value0(applicativeParAff)(evalChild)(v1.children)));
              })(cqb);
            });
          };
        };
        var go2 = function(ref2) {
          return function(v1) {
            if (v1 instanceof State) {
              return bind18(liftEffect5(read(ref2)))(function(v2) {
            ...
            if (v1 instanceof Subscribe) {
              return bind18(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind18(liftEffect5(subscribe(v1.value0(sid))(function(act) {
                  return handleAff(evalF(render4)(ref2)(new Action(act)));
                })))(function(finalize) {
                  return bind18(liftEffect5(read(ref2)))(function(v2) {
                    return discard12(liftEffect5(modify_(map210(insert14(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            if (v1 instanceof Raise) {
              return bind18(liftEffect5(read(ref2)))(function(v2) {
                return bind18(liftEffect5(read(v2.handlerRef)))(function(handler3) {
            ...
            if (v1 instanceof Fork) {
              return bind18(fresh(ForkId)(ref2))(function(fid) {
                return bind18(liftEffect5(read(ref2)))(function(v2) {
                  return bind18(liftEffect5($$new(false)))(function(doneRef) {
                    return bind18(fork3($$finally(liftEffect5(function __do3() {
                      modify_($$delete8(fid))(v2.forks)();
                      return write(true)(doneRef)();
                    }))(evalM(render4)(ref2)(v1.value0))))(function(fiber) {
                      return discard12(liftEffect5(unlessM2(read(doneRef))(modify_(insert15(fid)(fiber))(v2.forks))))(function() {
            ...
            if (v1 instanceof Join2) {
              return bind18(liftEffect5(read(ref2)))(function(v2) {
                return bind18(liftEffect5(read(v2.forks)))(function(forkMap) {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do3() {
                    var childrenIn = map41(slot.pop)(read(childrenInRef))();
                    var $$var2 = (function() {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind111(liftEffect7(map42(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind20(awaitBody)(function() {
    return bind20(selectElement("#app"))(function(mAppEl) {
      if (mAppEl instanceof Nothing) {
        return liftEffect8(log12("[Main] Error: #app element not found"));
      }
      ;
      if (mAppEl instanceof Just) {
        return bind20(runUI2(component2)(unit)(mAppEl.value0))(function() {
          return liftEffect8(log12("[Main] Code Explorer v2 started"));
        });
      }
      ;
