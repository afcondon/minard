...
(() => {
  // output/TypeSigViz.Main/foreign.js
  var exportParser = (parseFn) => () => {
  ...
  // output/TypeSigViz.TypeAST/foreign.js
  var mkOk = (ast) => ({ ok: true, ast });
  var mkErr = (error2) => ({ ok: false, error: error2 });
  var mkObj = (tag) => (fields) => {
    const obj = { tag };
            ...
            appendRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  return insert4(append12(get(ra))(get(rb)))(tail2);
                };
              };
            }
          };
  ...
  var insertLayout = function(v) {
    return function(nextPos) {
      return function(stack) {
        ...
        return insert4(new Tuple(stack, []));
      };
    };
  };
      ...
      return function(str) {
        ...
        var v1 = function(v2) {
          return new LexFail(function(v3) {
            return mkErr2(mkUnexpected(str));
          }, str);
        };
        if (v instanceof Just) {
          var $151 = head2(v.value0);
          if ($151 instanceof Just) {
            return new LexSucc($151.value0, drop2(length2($151.value0))(str));
          }
          ;
          return v1(true);
        }
  ...
  var string = function(mkErr2) {
    return function(match2) {
      return function(str) {
        var $156 = take2(length2(match2))(str) === match2;
        if ($156) {
  ...
  var map4 = /* @__PURE__ */ map(functorLex);
  var spaceComment = /* @__PURE__ */ (function() {
    return map4(length2)(regex2(LexExpected.create("spaces"))(" +"));
  })();
  ...
  var char$prime = function(mkErr2) {
    return function(res) {
      return function(match2) {
        return function(str) {
          var $172 = singleton4(match2) === take2(1)(str);
          if ($172) {
  ...
  var $$char = function(mkErr2) {
    return function(match2) {
      return function(str) {
        var $173 = singleton4(match2) === take2(1)(str);
        if ($173) {
            ...
            function $tco_loop(n, ix) {
              ...
              if (v1 instanceof Nothing) {
                ...
                if (otherwise) {
                  ...
                  return {
                    line: v.line + n | 0,
                    column: length3(drop2(ix)(str)) + colOffset | 0
                  };
                }
                ;
              }
  ...
  var leadingComments = /* @__PURE__ */ (function() {
    return many(alt2(map4(Comment.create)(comment))(alt2(map4(Space.create)(spaceComment))(lineComment)));
  })();
  var token = /* @__PURE__ */ (function() {
    ...
    var parseSymbol = map4(function(v) {
      return function(v1) {
        if (v1 instanceof Nothing) {
          if (v === "->") {
    ...
    var parseStringSpaceEscape = map4(function(v) {
      return {
        raw: v,
        string: ""
      };
    })(stringSpaceEscapeRegex);
    var parseStringChars = map4(function(v) {
      return {
        raw: v,
        string: v
      };
    })(stringCharsRegex);
    var parseRawString = map4(function(v) {
      return new TokRawString(dropRight(3)(drop2(3)(v)));
    })(rawStringCharsRegex);
    var parseProper = regex2(LexExpected.create("proper name"))("\\p{Lu}[\\p{L}0-9_']*");
    var parseUpper = map4(flip(TokUpperName.create))(parseProper);
    var parseOperator = map4(function(v) {
      return function(v1) {
        if (v1 instanceof Nothing) {
          if (v === "<-") {
    ...
    var parseLower = map4(function(v) {
      return function(v1) {
        if (v1 instanceof Nothing) {
          if (v === "forall") {
    ...
    var parseModuleName = apply2(map4(function(v) {
      return function(v1) {
    ...
    var parseExponentPart = apply2(map4(function(v) {
      return function(v1) {
        return {
          sign: v,
          exponent: v1
    ...
    var parseHole2 = map4(function(v) {
    ...
    var parseEscape = function(dictIsChar) {
      ...
      return bind1(charAny)(function(ch) {
        ...
        ;
        return fail(new LexInvalidCharEscape(singleton4(ch)));
      });
    };
    ...
    var parseCharLiteral = map4(function(v) {
      return new TokChar(v.raw, v["char"]);
    })(applyFirst2(applySecond2(charSingleQuote)(parseChar))(charSingleQuote));
    var parseStringEscape = map4(function(v) {
      return {
        raw: v.raw,
        string: singleton5(v["char"])
      };
    ...
    var parseString2 = map4(function(v) {
      var v1 = fold12(v);
  ...
  var trailingComments = /* @__PURE__ */ (function() {
    return many(alt2(map4(Comment.create)(comment))(map4(Space.create)(spaceComment)));
  })();
  var lexWithState$prime = function(lexLeadingComments) {
    var token$prime = apply2(apply2(map4(function(v) {
      return function(v1) {
        return function(v2) {
          return {
            token: v,
  ...
  var map6 = /* @__PURE__ */ map(functorParser);
  var applyParser = {
    apply: function(v) {
      return function(v1) {
        return function(state1, more, resume, done) {
  ...
  var optional2 = function(p) {
    return alt3(map6(Just.create)(p))(pure2(Nothing.value));
  };
  var many2 = function(v) {
    return function(state1, more, resume, done) {
      var $lazy_go = $runtime_lazy2("go", "PureScript.CST.Parser.Monad", function() {
        return function(acc, state2) {
          ...
          return v(state2$prime, more, function(state3, error2) {
            ...
            ;
            return done(state2, reverse(toUnfoldable3(acc)));
  ...
  var separated = function(sepParser) {
    return function(valueParser) {
      ...
      })(valueParser))(many2(apply3(map7(Tuple.create)(sepParser))(valueParser)));
    };
  };
  ...
  var many1 = function(parser) {
    return apply3(map7(cons$prime)(parser))(many2(parser));
  };
  ...
  var parseTypeNegative = /* @__PURE__ */ bind2(/* @__PURE__ */ tokKeyOperator("-"))(function(negative) {
    return map7(uncurry(TypeInt.create(new Just(negative))))($$parseInt);
  });
  ...
  var parseTypeVarKinded = function(parseBindingName) {
    return map7(TypeVarKinded.create)(parens(bind2(parseBindingName)(function(label) {
  ...
  var parseTypeVarBinding = function(parseBindingName) {
    return alt4(parseTypeVarKinded(parseBindingName))(map7(TypeVarName.create)(parseBindingName));
  };
  ...
  var parseRowTailParen = function(open) {
    return bind2(apply3(map7(Tuple.create)(tokPipe))($lazy_parseType(477)))(function(tail2) {
      return bind2(tokRightParen)(function(close) {
        return pure3(new TypeRow({
          open,
          value: {
  ...
  var parseRowParen = function(open) {
    return bind2($$try2(apply3(map7(Tuple.create)(parseLabel))(tokDoubleColon)))(function(v) {
      return bind2($lazy_parseType(459))(function(value) {
        return bind2(many2(apply3(map7(Tuple.create)(tokComma))($lazy_parseRowLabel(460))))(function(rest) {
          return bind2(optional2(apply3(map7(Tuple.create)(tokPipe))($lazy_parseType(461))))(function(tail2) {
            return bind2(tokRightParen)(function(close) {
              return pure3(new TypeRow({
                open,
                value: {
  ...
  var parseKindedVar = function(open) {
    return bind2($$try2(apply3(map7(Tuple.create)(parens(map7(TypeVar.create)(parseIdent))))(tokDoubleColon)))(function(v) {
  ...
  var $lazy_parseForall = /* @__PURE__ */ $runtime_lazy3("parseForall", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return apply3(apply3(apply3(map7(TypeForall.create)(tokForall))(many1($lazy_parseTypeVarBindingWithVisibility(528))))(tokDot))($lazy_parseType1(530));
    });
  });
  var $lazy_parseRow = /* @__PURE__ */ $runtime_lazy3("parseRow", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return bind2(optional2(separated(tokComma)($lazy_parseRowLabel(513))))(function(labels) {
        return bind2(optional2(apply3(map7(Tuple.create)(tokPipe))($lazy_parseType(514))))(function(tail2) {
          return pure3({
            labels,
            tail: tail2
          });
  ...
  var $lazy_parseRowLabel = /* @__PURE__ */ $runtime_lazy3("parseRowLabel", "PureScript.CST.Parser", function() {
  ...
  var $lazy_parseType = /* @__PURE__ */ $runtime_lazy3("parseType", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return bind2($lazy_parseType1(393))(function(ty) {
        return alt4(apply3(map7(TypeKinded.create(ty))(tokDoubleColon))($lazy_parseType(394)))(pure3(ty));
      });
    });
  });
  var $lazy_parseType1 = /* @__PURE__ */ $runtime_lazy3("parseType1", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return alt4($lazy_parseForall(399))($lazy_parseType2(400));
    });
  });
  var $lazy_parseType2 = /* @__PURE__ */ $runtime_lazy3("parseType2", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return bind2($lazy_parseType3(404))(function(ty) {
        return alt4(apply3(map7(TypeArrow.create(ty))(tokRightArrow))($lazy_parseType1(405)))(alt4(apply3(map7(TypeConstrained.create(ty))(tokRightFatArrow))($lazy_parseType1(406)))(pure3(ty)));
      });
    });
  });
  var $lazy_parseType3 = /* @__PURE__ */ $runtime_lazy3("parseType3", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return bind2($lazy_parseType4(411))(function(ty) {
        return bind2(many2(apply3(map7(Tuple.create)(parseQualifiedOperator))($lazy_parseType4(412))))(function(ops) {
  ...
  var $lazy_parseType4 = /* @__PURE__ */ $runtime_lazy3("parseType4", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return alt4(parseTypeNegative)($lazy_parseType5(419));
    });
  });
  var $lazy_parseType5 = /* @__PURE__ */ $runtime_lazy3("parseType5", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
  ...
  var $lazy_parseTypeAtom = /* @__PURE__ */ $runtime_lazy3("parseTypeAtom", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return alt4(map7(TypeVar.create)(parseIdent))(alt4(map7(TypeConstructor.create)(parseQualifiedProper))(alt4(map7(uncurry(TypeString.create))(parseString))(alt4(map7(uncurry(TypeInt.create(Nothing.value)))($$parseInt))(alt4($lazy_parseTypeParens(435))(alt4(map7(TypeRecord.create)(braces($lazy_parseRow(436))))(alt4(map7(TypeOpName.create)(parseQualifiedSymbol))(alt4(map7(TypeHole.create)(parseHole))(alt4(map7(TypeWildcard.create)(tokUnderscore))(map7(TypeArrowName.create)(tokSymbolArrow))))))))));
    });
  });
  var $lazy_parseTypeParens = /* @__PURE__ */ $runtime_lazy3("parseTypeParens", "PureScript.CST.Parser", function() {
  ...
  var $lazy_parseTypeVarBindingWithVisibility = /* @__PURE__ */ $runtime_lazy3("parseTypeVarBindingWithVisibility", "PureScript.CST.Parser", function() {
    return defer3(function(v) {
      return parseTypeVarBinding(apply3(map7(function(v1) {
        return function(v2) {
          return {
            prefix: v1,
            value: v2
  ...
  // output/TypeSigViz.TypeAST/index.js
  ...
  var unsafeLast = function(arr) {
    ...
    ;
    throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 265, column 18 - line 267, column 22): " + [v.constructor.name]);
  };
  var kv = function(k) {
    return function(v) {
      return {
  ...
  var initSafe = function($145) {
    return (function(v) {
      ...
      ;
      throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 271, column 27 - line 273, column 16): " + [v.constructor.name]);
    })(init($145));
  };
  var extractBinderName = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 117, column 21 - line 121, column 38): " + [v.constructor.name]);
  };
    ...
    return {
      fields: (function() {
        ...
        if (v.labels instanceof Just) {
          return cons(simplifyLabel(v.labels.value0.head))(map8(function($146) {
            return simplifyLabel(snd($146));
          })(v.labels.value0.tail));
        }
        ;
        throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 125, column 13 - line 128, column 75): " + [v.labels.constructor.name]);
      })(),
      tail: (function() {
        ...
        ;
        throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 129, column 11 - line 133, column 24): " + [v.tail.constructor.name]);
      })()
    };
  };
  ...
  var simplifyConstraint = function(v) {
    if (v instanceof TypeApp) {
      ...
      if (v1 instanceof TCon) {
        return {
          className: v1.value0,
          args: map8(simplify)(toArray(v.value1))
        };
      }
      ;
      return {
  ...
  var simplify = function(v) {
    ...
    if (v instanceof TypeConstructor) {
      ...
      ;
      throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 54, column 8 - line 56, column 54): " + [v.value0.module.constructor.name]);
    }
    ;
    ...
    if (v instanceof TypeForall) {
      ...
      if (inner instanceof TForall) {
        return new TForall(append1(vars)(inner.value0), inner.value1);
      }
      ;
    ...
    ;
    if (v instanceof TypeApp) {
      return new TApp(simplify(v.value0), map8(simplify)(toArray(v.value1)));
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 48, column 12 - line 114, column 36): " + [v.constructor.name]);
  };
  var collectArrows = function(from) {
    return function(to) {
      if (to instanceof TArrow) {
        return cons(from)(collectArrows(to.value0)(to.value1));
      }
      ;
      return [from, to];
    };
  ...
  var toJS = function(v) {
    if (v instanceof TVar) {
      return mkObj("typevar")([kv("name")(mkStr(v.value0))]);
    }
    ;
    if (v instanceof TCon) {
      return mkObj("constructor")([kv("name")(mkStr(v.value0))]);
    }
    ;
    if (v instanceof TWildcard) {
      return mkObj("typevar")([kv("name")(mkStr("_"))]);
    }
    ;
    ...
    if (v instanceof TApp) {
      return mkObj("applied")([kv("constructor")(toJS(v.value0)), kv("args")(mkArr(map8(toJS)(v.value1)))]);
    }
    ;
    if (v instanceof TArrow) {
      var parts = collectArrows(v.value0)(v.value1);
      var $121 = length(parts) === 2;
      if ($121) {
        return mkObj("function")([kv("params")(mkArr(map8(toJS)(take(1)(parts)))), kv("returnType")(toJS(unsafeLast(parts)))]);
      }
      ;
      return mkObj("function")([kv("params")(mkArr(map8(toJS)(initSafe(parts)))), kv("returnType")(toJS(unsafeLast(parts)))]);
    }
    ;
    if (v instanceof TConstrained) {
      return mkObj("constrained")([kv("constraints")(mkArr(map8(constraintToJS)(v.value0))), kv("body")(toJS(v.value1))]);
    }
    ;
    if (v instanceof TForall) {
      return mkObj("forall")([kv("vars")(mkArr(map8(mkStr)(v.value0))), kv("body")(toJS(v.value1))]);
    }
    ;
    if (v instanceof TRecord) {
      return mkObj("record")(fieldProps(v.value0)(v.value1));
    }
    ;
    if (v instanceof TRow) {
      return mkObj("row")(fieldProps(v.value0)(v.value1));
    }
    ;
    if (v instanceof TParens) {
      return mkObj("parens")([kv("inner")(toJS(v.value0))]);
    }
    ;
    if (v instanceof TKinded) {
      return mkObj("kinded")([kv("type")(toJS(v.value0)), kv("kind")(toJS(v.value1))]);
    }
    ;
    if (v instanceof TOperator) {
      return mkObj("operator")([kv("left")(toJS(v.value0)), kv("op")(mkStr(v.value1)), kv("right")(toJS(v.value2))]);
    }
    ;
    throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 184, column 8 - line 235, column 83): " + [v.constructor.name]);
  };
  var fieldToJS = function(f) {
    return mkObj("field")([kv("name")(mkStr(f.label)), kv("type")(toJS(f.value))]);
  };
  var fieldProps = function(fields) {
    return function(tail2) {
      return [kv("fields")(mkArr(map8(fieldToJS)(fields))), kv("rowVar")((function() {
        if (tail2 instanceof Just) {
          return mkStr(tail2.value0);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 240, column 18 - line 242, column 24): " + [tail2.constructor.name]);
      })())];
    };
  };
  var constraintToJS = function(c) {
    return mkObj("constraint")([kv("name")(mkStr(c.className)), kv("args")(mkArr(map8(toJS)(c.args)))]);
  };
  var parseAndExport = function(input) {
    var v = parseType2(input);
    if (v instanceof ParseSucceeded) {
      return mkOk(toJS(simplify(v.value0)));
    }
    ;
    ...
    if (v instanceof ParseFailed) {
      return mkErr("Parse failed");
    }
    ;
    throw new Error("Failed pattern match at TypeSigViz.TypeAST (line 159, column 24 - line 165, column 25): " + [v.constructor.name]);
  };

  // output/TypeSigViz.Main/index.js
