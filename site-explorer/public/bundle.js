...
(() => {
    ...
    return function(tree) {
      return function __do2() {
        var doc = (function __do3() {
          var $235 = bind6(windowImpl)(document2)();
  ...
  var linksTree = function(nodes) {
    return function(links) {
      ...
      return forEach("links")(Line.value)(links)(function(l) {
        return show4(l.source) + ("-" + show4(l.target));
      })(function(link3) {
  ...
  var renderSummary = function(state3) {
    ...
    return div_([h2_([text5("Summary")]), renderStat("Total routes")(show5(total)), renderStat("Reachable")(show5(reachable)), renderStat("Unreachable")(show5(unreachable)), renderStat("Extra (undocumented)")(show5(extra))]);
  };
